...
Orchestrator context management uses two parallel offload paths to handle the limited context window:
...
Orchestrator's context consists of two components:
...
- [MemoryCompactionHook](https://github.com/agentscope-ai/Orchestrator/blob/main/src/qwenpaw/agents/hooks/memory_compaction.py)
...
When the context approaches its limit, Orchestrator automatically triggers compaction, condensing old conversations into a structured summary.
